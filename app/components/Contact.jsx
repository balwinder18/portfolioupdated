...
export default function Contact() {
    ...
    return (
        <div className="mt-0 py-10 mx-6 bg-black rounded-xl p-5 text-white text-lg flex flex-col justify-center items-center sm:mt-0 sm:py-10 sm:mx-14 sm:bg-black sm:rounded-xl sm:p-5 sm:text-white sm:text-lg sm:flex sm:flex-col sm:justify-center sm:items-center   md:mt-14 md:py-10 md:mx-20 md:bg-black md:rounded-xl md:p-5 md:text-white md:text-lg md:flex md:flex-col md:justify-center md:items-center   lg:mt-14 lg:py-10 lg:mx-20 lg:bg-black lg:rounded-xl lg:p-5 lg:text-white lg:text-lg lg:flex lg:flex-col lg:justify-center lg:items-center   xl:mt-14 xl:py-10 xl:mx-20 xl:bg-black xl:rounded-xl xl:p-5 xl:text-white xl:text-lg xl:flex xl:flex-col xl:justify-center xl:items-center   2xl:mt-14 2xl:py-10 2xl:mx-20 2xl:bg-black 2xl:rounded-xl 2xl:p-5 2xl:text-white 2xl:text-lg 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:items-center">
            <div className=" mx-5 text-center my-5 flex flex-col justify-center items-center sm:my-5 sm:flex sm:flex-col sm:justify-center sm:items-center   md:my-5 md:flex md:flex-col md:justify-center md:items-center    lg:my-5 lg:flex lg:flex-col lg:justify-center lg:items-center    xl:my-5 xl:flex xl:flex-col xl:justify-center xl:items-center    2xl:my-5 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:items-center">
            ...
            <div className="my-5 flex flex-col w-full justify-center items-center sm:my-5 sm:flex sm:flex-col sm:w-full sm:justify-center sm:items-center md:my-5 md:flex md:flex-row md:w-full md:justify-center md:items-center   lg:my-5 lg:flex lg:flex-row lg:w-full lg:justify-center lg:items-center   xl:my-5 xl:flex xl:flex-row xl:w-full xl:justify-center xl:items-center    2xl:my-5 2xl:flex 2xl:flex-row 2xl:w-full 2xl:justify-center 2xl:items-center ">
                <div className=" bg-[#faf5f0] text-[#1e1b17] text-xs flex flex-row my-3 p-2 justify-center items-center font-bold w-[60%] rounded-md transition-all ease-in hover:scale-105 sm:bg-[#faf5f0] sm:text-[#1e1b17] sm:text-sm sm:flex sm:flex-row sm:mr-0 sm:p-2 sm:justify-center sm:items-center sm:font-bold sm:w-[40%] sm:rounded-md sm:transition-all sm:ease-in sm:hover:scale-105 md:bg-[#faf5f0] md:text-[#1e1b17] md:text-sm md:flex md:flex-row md:mr-3 md:p-2 md:justify-center md:items-center md:font-bold md:w-[35%] md:rounded-md md:transition-all md:ease-in md:hover:scale-105      lg:bg-[#faf5f0] lg:text-[#1e1b17] lg:text-sm lg:flex lg:flex-row lg:mr-3 lg:p-2 lg:justify-center lg:items-center lg:font-bold lg:w-[30%] lg:rounded-lg lg:transition-all lg:ease-in lg:hover:scale-105      xl:bg-[#faf5f0] xl:text-[#1e1b17] xl:text-sm xl:flex xl:flex-row xl:mr-3 xl:p-2 xl:justify-center xl:items-center xl:font-bold xl:w-[20%] xl:rounded-lg xl:transition-all xl:ease-in xl:hover:scale-105      2xl:bg-[#faf5f0] 2xl:text-[#1e1b17] 2xl:text-sm 2xl:flex 2xl:flex-row 2xl:mr-3 2xl:p-3 2xl:justify-center 2xl:items-center 2xl:font-bold 2xl:w-[20%] 2xl:rounded-md 2xl:transition-all 2xl:ease-in 2xl:hover:scale-105">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="mx-3 lucide lucide-phone">
                        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                    </svg><p className="mx-0 sm:mx-1 md:mx-0 lg:mx-3 xl:mx-3 2xl:mx-3">+91-9318326662</p>
                </div>
